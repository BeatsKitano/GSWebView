#
#  Be sure to run `pod spec lint GSWebView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "xorshine"
  s.authors            = { "xorshine" => "xorshine@icloud.com" }
  s.social_media_url   = "https://xorshine.github.io/"
  ...
  s.source       = { :git => "https://github.com/xorshine/GSWebView.git", :tag => "1.0}" }
